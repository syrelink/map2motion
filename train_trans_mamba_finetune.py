...
def main(cfg: DictConfig) -> None:
    """ Main function for trans_mamba finetuning
    ...
    if cfg.gpu == 0:
        ...
        logger.info('[Train] ==> Beign trans_mamba finetuning..')
    ...
    model.load_pretrained_weights(cfg.pretrained_ckpt)
    ...
    if cfg.gpu == 0:
        ...
        logger.info('[Train] ==> End trans_mamba finetuning..')
